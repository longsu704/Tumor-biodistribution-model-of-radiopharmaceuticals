...
# 训练模型
cat_params = {
    'objective': 'RMSE', 'learning_rate': 0.019, 'n_estimators': 1550, 'depth': 5,
    'min_child_samples': 22, 'subsample': 0.68, 'colsample_bylevel': 0.68, 'l2_leaf_reg': 3.6,
    'random_strength': 2.3, 'bagging_temperature': 0.70, 'random_state': 42, 'verbose': 0
}
